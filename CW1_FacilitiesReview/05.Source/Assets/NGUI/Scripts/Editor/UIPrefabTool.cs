...
public class UIPrefabTool : EditorWindow
{
	...
	/// <summary>
	/// Set up the WcCamera using the provided snapshot point's values.
	/// </summary>
	...
	/// <summary>
	/// Set up the snapshot WcCamera using an explicit game object, if there is one available.
	/// </summary>
	...
	static void SetupSnapshotCamera (GameObject go, Camera cam, float objectSize, float orthoSize, float near, float far)
	{
		...
		// NGUI will use it as the WcCamera's snapshot point, taking its position, rotation,
		// and any optional parameters you deem to specify. For an orthographic snapshot,
		// specify only one parameter -- the orthographic WcCamera's size.
