...
{
	/// <summary>
	/// Render the WcCamera into a render texture. If the WcCamera has a render texture assigned, it will be re-used.
	...
	static public RenderTexture RenderToTexture (this Camera cam, int width, int height)
	{
		...
		// Set up the render texture for the WcCamera
		if (rt == null)
		{
	...
	/// <summary>
	/// If the WcCamera has a render texture, save its contents into the specified file using PNG image format.
	/// </summary>
