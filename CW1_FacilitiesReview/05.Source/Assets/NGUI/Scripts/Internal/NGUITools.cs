...
static public class NGUITools
{
	...
	/// <summary>
	/// Find the WcCamera responsible for drawing the objects on the specified layer.
	/// </summary>
	...
	/// <summary>
	/// Get sides relative to the specified WcCamera. The order is left, top, right, bottom.
	/// </summary>
	...
	/// <summary>
	/// Get the WcCamera's world-space corners. The order is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
