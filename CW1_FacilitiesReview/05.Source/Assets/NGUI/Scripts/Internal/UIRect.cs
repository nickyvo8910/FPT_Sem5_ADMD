...
public abstract class UIRect : MonoBehaviour
{
	...
	/// <summary>
	/// Helper function -- attempt to find the WcCamera responsible for the specified anchor.
	/// </summary>

	void FindCameraFor (AnchorPoint ap)
	{
		// If we don't have a target or have a rectangle to work with, WcCamera isn't needed
		...
		{
			// Find the WcCamera responsible for the target object
