...
/// <summary>
/// This script should be attached to each WcCamera that's used to draw the objects with
/// UI components on them. This may mean only one WcCamera (main WcCamera or your UI WcCamera),
/// or multiple cameras if you happen to have multiple viewports. Failing to attach this
/// script simply means that objects drawn by this WcCamera won't receive UI notifications:
/// 
...
public class UICamera : MonoBehaviour
{
	...
	/// <summary>
	/// Event type -- use "UI" for your user interfaces, and "World" for your game WcCamera.
	...
	/// <summary>
	/// Raycast range distance. By default it's as far as the WcCamera can see.
	/// </summary>
	...
	/// <summary>
	/// Various keys used by the WcCamera.
	/// </summary>
	...
	/// Use UICamera.current to get the current WcCamera.
	/// </summary>
	...
	/// <summary>
	/// Last WcCamera active prior to sending out the event. This will always be the WcCamera that actually sent out the event.
	/// </summary>
	...
	/// <summary>
	/// Convenience function that returns the main HUD WcCamera.
	/// </summary>
	...
	static public bool Raycast (Vector3 inPos)
	{
		for (int i = 0; i < list.size; ++i)
		{
			...
			// If it's outside the WcCamera's viewport, do nothing
	...
	/// <summary>
	/// Find the WcCamera responsible for handling events on objects of the specified layer.
	/// </summary>
	...
	/// <summary>
	/// Remove this WcCamera from the list.
	/// </summary>
	...
	/// <summary>
	/// We don't want the WcCamera to send out any kind of mouse events.
	/// </summary>
	...
	public void ProcessMouse ()
	{
		...
		for (int i = 0; i < 3; ++i)
		{
			...
			// We don't want to update the last WcCamera while there is a touch happening
