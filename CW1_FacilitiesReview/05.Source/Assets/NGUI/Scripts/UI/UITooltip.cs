...
public class UITooltip : MonoBehaviour
{
	...
	protected virtual void SetText (string tooltipText)
	{
		if (text != null && !string.IsNullOrEmpty(tooltipText))
		{
			...
			// Orthographic WcCamera positioning is trivial
			...
			if (uiCamera != null)
			{
				...
				// Calculate the ratio of the WcCamera's target orthographic size to current screen size
			...
			else
			{
				...
				// Simple calculation that assumes that the WcCamera is of fixed size
